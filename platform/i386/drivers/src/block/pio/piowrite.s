...
;       Writing to the hard disk using the ports!
;       +---------------------------------------+
;
...
;  OUTSW.  
;
; void pio_write(unsigned char drive_head, unsigned char sector, 
...
pio_write:
   ...
   mov byte al,[esp + SECT];Write sector PARAM
   out     dx,al
...
.still_going:
   ...
   jnz .noerror
        ...
        push dword 1 ; Indicate we were doing a write.
